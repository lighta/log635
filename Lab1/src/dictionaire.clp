...
(deffacts map_arme-trauma
	(arme masse peut cree trauma (list Hemorragie Hematome))
	...
	(arme fourchette peut cree trauma (list Hemorragie Traumatism_cranien Hematome Traumatisme_thoracique))
)

;Constantes pour déterminer une arme selon son traumatisme creer
(deffacts map_arme-trace
	(arme masse laisse trace (list Rectangulaire Localise))
...
(deffacts map_arme-metier
	...
	(Metier Professeur possede arme (list crayon corde))
...
(deffacts map_arme-experience
	...
	(Arme fourchette necessite Experimente)
)

;Constante pour determiner un motif selon la relation avec un autre individu
(deffacts map_lieu_arme
	(Armes contenues dans canal-lachine sont (list barre_a_clou))
	(Armes contenues dans centre-des-sciences sont (list fusil))
	;(Armes contenues dans chinatown sont (list xx))
	(Armes contenues dans gare-blainville sont (list masse))
	(Armes contenues dans gare-centrale sont (list masse))
	(Armes contenues dans gare-deux-montagnes sont (list masse))
	(Armes contenues dans gare-repentigny sont (list masse))
	(Armes contenues dans hopital-notre-dame sont (list masse crayon))
	(Armes contenues dans hotel-de-ville sont (list masse crayon))
	(Armes contenues dans la-ronde sont (list tournevis))
	(Armes contenues dans metro-angrignon sont (list fusil))
	(Armes contenues dans metro-atwater sont (list corde couteau))
	;(Armes contenues dans metro-berri-uqam sont (list xx))
	;(Armes contenues dans metro-honore-beaugrand sont (list xx))
	(Armes contenues dans metro-jean-talon sont (list corde couteau))
	;(Armes contenues dans metro-montmorency sont (list xx))
	(Armes contenues dans mont-royal sont (list fusil masse))
	;(Armes contenues dans parc-jean-drapeau sont (list xx))
	(Armes contenues dans peel-pub sont (list fusil))
	(Armes contenues dans polytechnique sont (list crayon))
	(Armes contenues dans stade-olympique sont (list corde))
	(Armes contenues dans station-train-roxboro-pierrefonds sont (list fusil))
	(Armes contenues dans uqam sont (list tournevis barre_a_clou))
	(Armes contenues dans universite-de-montreal sont (list tournevis crayon))
	(Armes contenues dans ets-cafeteria sont (list couteau fourchette))
	;(Armes contenues dans ets-coop sont (list corde crayon))
	(Armes contenues dans ets-100genie sont (list tournevis fourchette))
)
